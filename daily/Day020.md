...
**场景**：本机运行了一个 Web 服务（如 IIS/Apache/Nginx），需要确认版本。
...
**场景**：有 3 台主机（192.168.1.100-102），批量枚举。
