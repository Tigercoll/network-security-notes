...
- 掌握 Windows 操作系统安全基础，包括 UAC 原理、用户与组管理、事件日志分析、防火墙配置、本地安全策略、端口监听排查
- 学会通过 GUI + PowerShell 双工具进行 Windows 安全审计与加固
...
# ----                          --------------- -----------
# PC01\Administrator            Local           User
# PC01\alice                    Local           User
# AzureAD\ITAdmin@company.com   AzureActiveDirectory User
```
