...
| 文档 | 说明 | 链接 |
|------|------|------|
| **学习路线图** | 本文档：90 天详细安排 | `3-month-roadmap.md` |
| **实验环境搭建** | 虚拟机、工具、网络配置指南 | `lab-setup-guide.md` |
| **技能矩阵** | 技能自评与能力追踪 | `skills-matrix.md` |
| **学习资源汇总** | 书籍、课程、工具、社区链接 | `learning-resources.md` |

---

## 开始前的准备

1. **搭建实验环境** → 参考 `lab-setup-guide.md`
2. **了解技能矩阵** → 参考 `skills-matrix.md`
3. **准备学习资源** → 参考 `learning-resources.md`
